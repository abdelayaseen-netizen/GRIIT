...
const s = StyleSheet.create({
  ...
  notFoundText: { fontSize: 18, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD, color: DS_COLORS.TEXT_PRIMARY, marginBottom: 16 },
  ...
  pillText: { color: DS_COLORS.WHITE, fontSize: 13, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD },
  scroll: { flex: 1 },
  ...
  missionTaskTitle: { fontSize: 15, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD, color: DS_COLORS.TEXT_PRIMARY },
