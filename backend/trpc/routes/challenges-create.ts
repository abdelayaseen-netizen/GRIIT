  ...
  create: protectedProcedure
    .input(z.object({
      ...
      tasks: z.array(z.object({
        ...
        location_radius_meters: z.number().optional(),
        location_name: z.string().max(200).optional(),
        require_camera_only: z.boolean().optional(),
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      // PAY-02: free-tier cap is active enrollments (created or joined).
        ...
        buildTaskInsertPayload(
          {
            ...
            hard_mode: task.hard_mode,
            schedule_window_start: task.schedule_window_start,
            schedule_window_end: task.schedule_window_end,
            ...
            require_camera_only: task.require_camera_only,
