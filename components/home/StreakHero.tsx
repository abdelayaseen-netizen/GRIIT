      ...
      <View style={s.row}>
        <View style={s.ringCol}>
          <Svg width={RING_SIZE} height={RING_SIZE}>
            <Circle cx={RING_SIZE / 2} cy={RING_SIZE / 2} r={R} stroke={DS_COLORS.BORDER} strokeWidth={STROKE} fill="none" />
            <Circle
              cx={RING_SIZE / 2}
              cy={RING_SIZE / 2}
              r={R}
        ...
        <View style={s.streakWords}>
          <Text style={s.dayWord}>day</Text>
          <Text style={s.streakWord}>streak</Text>
        </View>
        <View style={s.right}>
...
const s = StyleSheet.create({
  ...
  ringCol: { width: RING_SIZE, height: RING_SIZE, alignItems: "center", justifyContent: "center" },
  streakNum: {
    fontSize: 44,
    fontWeight: "800",
  ...
  streakWords: { justifyContent: "center" },
  dayWord: { fontSize: 13, fontWeight: "700", color: DS_COLORS.TEXT_PRIMARY },
  streakWord: { fontSize: 11, color: DS_COLORS.TEXT_MUTED },
