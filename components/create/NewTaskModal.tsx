...
const s = StyleSheet.create({
  ...
  headerLink: { fontSize: 14, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD, color: GRIIT_COLORS.primary },
  ...
  typeSectionTitle: { fontSize: 15, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD, color: DS_COLORS.TEXT_PRIMARY, marginBottom: 10, marginTop: 20 },
  ...
  taskName: { fontSize: 14, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD, color: DS_COLORS.TEXT_PRIMARY },
