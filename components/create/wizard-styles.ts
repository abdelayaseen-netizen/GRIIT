...
export const styles = StyleSheet.create({
  ...
  topTitle: { fontSize: 17, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD, color: DS_COLORS.TEXT_PRIMARY },
  ...
  fieldLabel: { fontSize: 15, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD, color: DS_COLORS.textSecondary, marginBottom: 8 },
  ...
  packsHead: { fontSize: 15, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD, color: DS_COLORS.TEXT_MUTED, marginBottom: 8 },
  packCard: {
    backgroundColor: DS_COLORS.surface,
    borderRadius: DS_RADIUS.LG,
    borderWidth: 1,
  ...
  listHead: { fontSize: 15, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD, color: DS_COLORS.TEXT_PRIMARY, marginTop: 16, marginBottom: 8 },
  taskRow: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  taskTitle: { flexShrink: 1, fontSize: 15, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD, color: DS_COLORS.TEXT_PRIMARY },
  hardBadge: {
    backgroundColor: DS_COLORS.ACCENT_TINT,
    paddingHorizontal: 8,
    paddingVertical: 2,
  ...
  ruleTitle: { fontSize: 15, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD, marginBottom: 6, color: DS_COLORS.TEXT_PRIMARY },
  ...
  outlineBtnTxt: { color: GRIIT_COLORS.primary, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD },
  ...
  primaryTxt: { color: DS_COLORS.TEXT_ON_DARK, fontSize: 17, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD },
  ...
  launchTxt: { color: DS_COLORS.TEXT_ON_DARK, fontSize: 17, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD },
  ...
  draftExitDangerTxt: { fontSize: 16, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD, color: DS_COLORS.dangerDark },
  draftExitSecondary: {
    borderRadius: DS_RADIUS.MD,
    paddingVertical: 14,
    alignItems: "center",
  ...
  draftExitSecondaryTxt: { fontSize: 16, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD, color: DS_COLORS.TEXT_PRIMARY },
  flex1: { flex: 1 },
  shakeWrap: {},
  ...
  text13SemiboldPrimary: { fontSize: 13, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD, color: DS_COLORS.PRIMARY },
  ...
  text18: { fontSize: 18 },
  text16SemiboldPrimary: { fontSize: 16, fontWeight: DS_TYPOGRAPHY.WEIGHT_BOLD, color: DS_COLORS.TEXT_PRIMARY },
