...
const styles = StyleSheet.create({
  ...
  goalCardSelected: { borderColor: C.accent, backgroundColor: C.accentMuted },
  ...
  goalTitleSelected: { color: C.accentLight },
  goalSubtitle: { fontSize: T.captionSize, color: C.textTertiary },
  checkMark: { width: 24, height: 24, borderRadius: 12, backgroundColor: C.accent, justifyContent: 'center', alignItems: 'center' },
