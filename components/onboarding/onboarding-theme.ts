...
export const ONBOARDING_COLORS = {
  ...
  badgePopularBg: DS_COLORS.BADGE_HARD_BG,
  badgePopularText: DS_COLORS.BADGE_HARD_RED,
  badgeStarterBg: DS_COLORS.BADGE_LOC_BG,
  badgeStarterText: DS_COLORS.BADGE_LOC_GREEN,
  metaPillBg: DS_COLORS.ONBOARDING_BG_PAGE,
