/**
 * Workout · Capture body — optional photo proof (task-states-v2).
...
export type TaskWorkoutCaptureBodyProps = {
...
export function TaskWorkoutCaptureBody({
  config,
  photoUri,
  photoUploading,
  onTakePhoto,
  onClearPhoto,
}: TaskWorkoutCaptureBodyProps) {
  ...
  return (
    <View style={styles.root}>
      ...
      <Text style={styles.sub}>Optional — skip if you finished without one.</Text>
