...
const s = StyleSheet.create({
  card: { borderRadius: 20, backgroundColor: "#1A1410", overflow: "hidden", marginTop: 18 },
  ...
  title: { fontSize: 21, fontWeight: "800", color: "#fff", lineHeight: 24, letterSpacing: -0.4 },
  ...
  avatar: { width: 22, height: 22, borderRadius: 11, borderWidth: 2, borderColor: "#1A1410", alignItems: "center", justifyContent: "center" },
  ...
  cta: { marginTop: 16, alignSelf: "flex-start", borderRadius: 28, paddingVertical: 12, paddingHorizontal: 32, backgroundColor: "#E8593C" },
